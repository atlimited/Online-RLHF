...
class PreferenceTrainer(DPOTrainer):
    def __init__(
        ...
        eval_reference_rejected_logps: Optional[torch.FloatTensor] = None,
    ):
        ...
        self.eval_reference_rejected_logps = eval_reference_rejected_logps
    ...
    def get_eval_dataloader(self, eval_dataset: Optional[Dataset] = None) -> DataLoader:
        ...
        if self.precompute_ref_log_probs and not self._precomputed_eval_ref_log_probs:
            ...
            all_reference_chosen_logps = torch.cat(self.eval_reference_chosen_logps).float().numpy()
            all_reference_rejected_logps = torch.cat(self.eval_reference_rejected_logps).float().numpy()
